                ...
                <ul class="list-unstyled margin-none">
                  <li class="rightsidebar-contact-wrapper">
                    <a class="rightsidebar-contact" href="javascript:void(0)">
                      <img src="../../assets/img/authors/avatar6.jpg" class="rounded-circle float-right"
                           alt="avatar-image">
                  ...
                  <li class="rightsidebar-contact-wrapper">
                    <a class="rightsidebar-contact" href="javascript:void(0)">
                      <img src="../../assets/img/authors/avatar.jpg" class="rounded-circle float-right"
                           alt="avatar-image">
                  ...
                  <li class="rightsidebar-contact-wrapper">
                    <a class="rightsidebar-contact" href="javascript:void(0)">
                      <img src="../../assets/img/authors/avatar2.jpg" class="rounded-circle float-right"
                           alt="avatar-image">
                  ...
                  <li class="rightsidebar-contact-wrapper">
                    <a class="rightsidebar-contact" href="javascript:void(0)">
                      <img src="../../assets/img/authors/avatar3.jpg" class="rounded-circle float-right"
                           alt="avatar-image">
                  ...
                  <li class="rightsidebar-contact-wrapper">
                    <a class="rightsidebar-contact" href="javascript:void(0)">
                      <img src="../../assets/img/authors/avatar4.jpg" class="rounded-circle float-right"
                           alt="avatar-image">
                  ...
                  <li class="rightsidebar-contact-wrapper">
                    <a class="rightsidebar-contact" href="javascript:void(0)">
                      <img src="../../assets/img/authors/avatar5.jpg" class="rounded-circle float-right"
                           alt="avatar-image">
                  ...
                  <li class="rightsidebar-contact-wrapper">
                    <a class="rightsidebar-contact" href="javascript:void(0)">
                      <img src="../../assets/img/authors/avatar7.jpg" class="rounded-circle float-right"
                           alt="avatar-image">
